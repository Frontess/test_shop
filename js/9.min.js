//Работа с куками. Локализация месяцев и дней недели.
//Функция AdcLandDate используется для работы с датами
...
document.addEventListener(
  "click",
  function (e) {
    if (!e.target.classList.contains("order-btn") || !e.target.closest("form"))
      return !0;
  ...
  $(".wheel__cursor").click(function () {
    if (!wheel.classList.contains("rotated")) {
      ...
      setTimeout(function () {
        ...
        $(".wheel__wrapper").slideUp(); // Скрыть колесо
        $(".order").removeClass("hidden").addClass("visible"); // Показать форму
      }, 8000); // Время анимации вращения колеса
...
// Изменение текста и загрузка изображений
//   function changeText() {
//   if ("" != $("#textareaname").val())
//     if (
...
//           )
//         : $(".formResult").html("<p><b>Données incorrectes.</b></p>"),
//       $(".formResult").css({
